...
entity dec4to16 is
    port (
        w  : in  std_logic_vector(3 downto 0);   -- student_id/current_state
        En : in  std_logic; -- enable of decoder
        OP  : out std_logic_vector(15 downto 0)  -- this is operational selector
    );
end dec4to16;
