...
ENTITY sevenSegment7 IS
    PORT (
        bcd  : IN  STD_LOGIC_VECTOR(3 DOWNTO 0);
        Sign  : IN  STD_LOGIC;
        leds1 : OUT STD_LOGIC_VECTOR(0 TO 6); -- leds have 7 segments (displays value in hex.)
        leds2 : OUT STD_LOGIC_VECTOR(0 TO 6) -- leds have 7 segments (displays sign)
    );
END sevenSegment7;

ARCHITECTURE Behavior OF sevenSegment7 IS
BEGIN
    PROCESS(bcd, Sign)
    BEGIN
        IF (Sign = '1') THEN
        ...
        CASE bcd IS
            ...
            WHEN OTHERS => leds1 <= NOT("0000000"); -- blank
